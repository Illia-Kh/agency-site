  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="h-11 rounded-full px-6 text-sm font-semibold text-[var(--white)] border border-[var(--primary)] bg-transparent transition-all duration-150 hover:bg-[color-mix(in_oklab,var(--primary)_10%,transparent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 active:bg-[color-mix(in_oklab,var(--primary)_20%,transparent)] inline-flex items-center justify-center gap-2 whitespace-nowrap"
